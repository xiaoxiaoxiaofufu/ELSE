...
def train(opt, train_loader, model, epoch, val_loader):
    ...
    num_loader_iter = len(train_loader.dataset) // train_loader.batch_size + 1  # len//bs + 1 iterations
    ...
    for i, train_data in enumerate(train_loader):
        ...
        # Update the model
        images, img_lengths, captions, lengths, _ = train_data     # _:index{list:128}
