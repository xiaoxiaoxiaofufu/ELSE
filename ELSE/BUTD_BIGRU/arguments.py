...
def get_argument_parser():
    ...
    parser.add_argument('--hardnum', type=int, default=2,
                        help='the number of expanding samples')
    parser.add_argument('--use_moco', default='1',
                        help='use moco to train')
    parser.add_argument('--moco_M', default=4096,
                        help='self.register_buffer("t_queue", torch.rand(opt.embed_size, self.K))')
    parser.add_argument('--moco_r', default=0.999,
                        help='use moco to train')
    parser.add_argument('--mu', default=70, type=float)
